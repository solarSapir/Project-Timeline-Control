...
const apiGroups: ApiGroup[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "PATCH", path: "/api/pause-reasons/logs/:id", description: "Edit a pause log entry", tables: ["pause_logs"], usedBy: ["Paused Projects"] },
      { method: "POST", path: "/api/pause-reasons/insights", description: "AI insights", tables: ["pause_logs"], usedBy: ["Insights"] },
    ],
  },
  {
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "DELETE", path: "/api/document-templates/:id", description: "Archive template (soft-delete, 120-day retention)", tables: ["document_templates"], usedBy: ["Settings"] },
      { method: "GET", path: "/api/document-templates/archived/list", description: "List archived templates with expiry dates", tables: ["document_templates"], usedBy: ["Settings"] },
      { method: "POST", path: "/api/document-templates/:id/restore", description: "Restore an archived template", tables: ["document_templates"], usedBy: ["Settings"] },
      { method: "DELETE", path: "/api/document-templates/:id/permanent", description: "Permanently delete archived template and files", tables: ["document_templates", "template_fields"], usedBy: ["Settings"] },
