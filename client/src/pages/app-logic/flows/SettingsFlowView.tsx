...
const initialNodes: Node[] = [
  ...
  { id: "auto-sync", type: "flowNode", position: { x: 0, y: 400 }, data: { label: "Auto-Sync", type: "logic", description: "Automatic background sync", items: ["Every 15 minutes (server-side timer)", "Initial sync on server start", "Pulls Asana changes automatically", "Status changes in app → pushed immediately"] } },
  ...
  { id: "db-workflow", type: "flowNode", position: { x: 600, y: 420 }, data: { label: "Tables Used", type: "data", description: "Database tables modified by settings", items: ["workflow_config → stage dependencies", "hrsp_config → document requirements", "uc_workflow_rules → UC hide/escalation rules", "projects → updated during sync"] } },
];
