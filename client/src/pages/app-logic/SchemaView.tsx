...
const tables: TableDef[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "note", type: "text" },
      { name: "actionRequired", type: "text" },
      { name: "nextSteps", type: "text" },
      { name: "staffName", type: "text" },
      { name: "followUpDate", type: "date" },
      { name: "actionType", type: "text", note: "reason | follow_up | timer_reset | marked_lost" },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "createdAt", type: "timestamp" },
      { name: "archivedAt", type: "timestamp", note: "soft-delete, 120-day retention" },
    ],
  },
  {
