...
import { AlertTriangle, CheckCircle2, Clock, Search, Maximize2 } from "lucide-react";
...
export default function UCView() {
  ...
  const totalNeedAction = installProjects.filter(p => !isUcComplete(p.ucStatus)).length;
