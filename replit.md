...
## Recent Changes
- 2026-02-24: Install Team Stage workflow — checkboxes for Contract Signed (→ "Pending Deposit") and $1,500 Deposit (→ "Pending site visit" if site visit not done, "Active Install" if Visit Complete/Booked). Auto-corrects "NEW CX pending other teams" → "Need contract" when UC complete. Auto-advances "Pending site visit" → "Active Install" when site visit done. All syncs to Asana bidirectionally.
