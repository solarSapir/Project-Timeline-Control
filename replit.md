...
- **PM Status Breakdown Chart**: Dashboard pie chart (recharts) showing how many projects are in each PM Status (Active, Project Paused, Project Lost, Complete, etc.) with counts, percentages, and a colored legend.
